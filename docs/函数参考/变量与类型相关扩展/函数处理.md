...
var_dump(call_user_func_array('Bar::method', [1, 2]));             // int(3)
var_dump(call_user_func_array(['Baz', 'method'], [1, 2]));         // int(2)
var_dump(call_user_func_array('Baz::method', [1, 2]));             // int(2)
var_dump(call_user_func_array(['Baz', 'parent::method'], [1, 2])); // int(3)
var_dump(call_user_func_array(new Qux, [1, 2]));                   // int(3)
...
var_dump(call_user_func('Bar::method', 1, 2));             // int(3)
var_dump(call_user_func(['Baz', 'method'], 1, 2));         // int(2)
var_dump(call_user_func('Baz::method', 1, 2));             // int(2)
var_dump(call_user_func(['Baz', 'parent::method'], 1, 2)); // int(3)
var_dump(call_user_func(new Qux, 1, 2));                   // int(3)
...
class Quux
{
    ...
    public static function method()
    {
        ...
        forward_static_call_array('Bar::method', [1, 2]);
        forward_static_call_array(['Baz', 'method'], [1, 2]);
        forward_static_call_array('Baz::method', [1, 2]);
        forward_static_call_array(['Baz', 'parent::method'], [1, 2]);
        forward_static_call_array(new Qux, [1, 2]);
    }
}
...
class Quux
{
    ...
    public static function method()
    {
        ...
        forward_static_call('Bar::method', 1, 2);
        forward_static_call(['Baz', 'method'], 1, 2);
        forward_static_call('Baz::method', 1, 2);
        forward_static_call(['Baz', 'parent::method'], 1, 2);
        forward_static_call(new Qux, 1, 2);
    }
}
